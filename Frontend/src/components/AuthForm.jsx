...
const AuthForm = ({ signIn }) => {
  ...
  return (
    <section className="authform-section">
      <div className={`authform-container shadow-sm shadow-skin-base text-skin-base rounded-lg w-[90%] duration-300 transition-all mx-auto max-w-[25rem] ${signingIn? "h-[30rem]":"h-[37rem]"}`}>
        <div className="form-components w-full h-full flex flex-col justify-around items-center">
            ...
            <div className={"form-body  w-full transition-transform duration-300 h-full"}>
