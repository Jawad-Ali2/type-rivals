...
const ThemeSwitch = ()=>{
    ...
    <div onMouseEnter={handleOnFocusEnter} onMouseLeave={handleOnFocusExit} className="theme-switch-container fixed z-[1000] w-[10rem] right-[2rem] bottom-[1rem]">
        <div className="options-container transition-all opacity-0 duration-300 w-[10rem]  fixed z-[1000] right-[2rem] bottom-[5rem] rounded-lg  border-2 border-primary-f bg-primary-e">
